...
{-
data BotState c m u = BSG {
    logH :: L.Handle,
    httpH :: H.HttpHandle,
    stConst :: StateTotalConst c,
    stMut :: IORef (StateTotalMutable m u)
    }
-}
{-
data StateTotalConst c = StTotConst {
    stGen :: StateGeneral,
    stSpConst :: c
    }

data StateTotalMutable m u = StTotMut {
    stSpMut :: m,
    stMap :: M.Map u Int
    } deriving (Show)
-}
